  ...
  return (
    <div className="bg-white rounded-lg shadow">
            ...
            {spots.map((spot) => (
              <tr key={spot.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900">₹{spot.rate}/month</div>
                </td>
                <td className="px-6 py-4">
                  ...
                  <div className="text-sm text-gray-500">
                    ...
                    {spot.address.pincode}
                  </div>
                  <div className="text-xs text-gray-400 flex items-center mt-1">
                    <MapPin className="h-3 w-3 mr-1" />
                    {spot.address.latitude.toFixed(4)},{" "}
                    {spot.address.longitude.toFixed(4)}
                  </div>
                </td>
                <td className="px-6 py-4">
      ...
      <div className="md:hidden">
        {spots.map((spot) => (
          <div key={spot.id} className="border-b border-gray-200 p-4 space-y-3">
            <div className="flex justify-between items-start">
              <div>
                <h3 className="text-sm font-medium text-gray-900">
                  {spot.name}
                </h3>
                <p className="text-sm text-gray-500 mt-1">₹{spot.rate}/month</p>
              </div>
              <span
            ...
            {spot.images.length > 0 && (
              <div className="flex -space-x-2">
                ...
                {spot.images.length > 3 && (
                  <div className="flex items-center justify-center h-10 w-10 rounded-full bg-gray-200 ring-2 ring-white">
                    <span className="text-xs text-gray-600">
                      +{spot.images.length - 3}
                    </span>
                  </div>
